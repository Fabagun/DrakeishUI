...
local defaults = {
	profile = {
		general = {
			...
			highlight = false, -- highlight plates on mouse-over
			highlight_target = false,
			fixaa = true, -- attempt to make plates appear sharper
			compatibility = false,
			bartexture = "Kui shaded bar",
			targetglow = false,
			targetglowcolour = {1, 1, 1, 1},
			targetarrows = false,
			hheight = 7,
			thheight = 7,
			width = 120,
		...
		fade = {
			...
			fadeall = true, -- fade all plates by default
			fadedalpha = .0, -- the alpha value to fade plates out to
			rules = {
		...
		hp = {
			reactioncolours = {
				hatedcol = {1.0, 0.0, 0.0},
				neutralcol = {1.0, 1.0, 0.0},
				friendlycol = {.0, 1.0, 0.0},
				tappedcol = {.5, 0.5, 0.5},
				playercol = {.2, 0.5, 0.9}
			},
			bar = {
