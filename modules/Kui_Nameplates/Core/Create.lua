...
function addon:CreateBackground(frame, f)
	...
	f.bg.fill:SetVertexColor(0, 0, 0, .2)
	...
	for side, coords in pairs(side_coords) do
		...
		side:SetTexture("Interface\\AddOns\\DrakeishUI\\modules\\Kui_Nameplates\\Media\\FrameGlow")
...
function addon:CreateTargetGlow(f)
	...
	f.targetGlow:SetTexture("Interface\\AddOns\\DrakeishUI\\modules\\Kui_Nameplates\\Media\\target-glow")
